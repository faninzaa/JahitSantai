<x-layouts.guest>
    <div class="w-full max-w-xl bg-white rounded-2xl shadow-md border border-gray-100 p-10">
        <div class="mb-7">
            ...
            <p class="text-base text-gray-500 mt-1">Masuk untuk melanjutkan pesananmu.</p>
        </div>
        ...
        <form method="POST" action="{{ route('login.submit') }}">
            ...
            <div class="mb-5">
                ...
                <div class="relative mt-1.5">
                    ...
                    <input id="password" type="password" name="password" required autocomplete="current-password"
                        class="block w-full text-sm rounded-lg bg-gray-100 border border-gray-200 pl-10 py-2.5 focus:ring-2 focus:ring-navy focus:border-navy" />
                </div>
            </div>
            ...
            <p class="text-center text-sm text-gray-600 mb-3">
                Belum memiliki akun?
                <a href="{{ route('register') }}" class="font-semibold text-gray-900 hover:underline">Daftar
                    sekarang!</a>
            </p>
