...
<body class="bg-white text-slate-800">
    ...
    <header class="bg-white sticky top-0 z-50 border-b border-slate-100">
        <nav class="max-w-7xl mx-auto px-6 md:px-10 h-20 flex items-center justify-between">
            ...
            <ul class="hidden md:flex items-center gap-10 text-slate-700 font-medium">
                <li><a href="{{ url('/beranda') }}" class="text-slate-900 border-b-2 border-slate-900 pb-1">{{
                        __('nav.home') }}</a></li>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-6 md:px-10">
            <div class="text-center max-w-2xl mx-auto">
                <h2 class="text-3xl md:text-4xl font-bold text-slate-900">{{ __('beranda.services_title') }}</h2>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-6 md:px-10">
            <div class="text-center max-w-2xl mx-auto">
                <h2 class="text-3xl md:text-4xl font-bold text-slate-900">{{ __('beranda.testimoni_title') }}</h2>
                <p class="mt-4 text-slate-500">{{ __('beranda.testimoni_subtitle') }}</p>
            </div>

            <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @for ($i = 0; $i < 4; $i++) <div class="bg-white rounded-xl p-6 border border-slate-100">
                    <div class="flex items-center gap-3">
                        <img src="{{ asset('images/profilghea.jpg') }}" alt="Testimoni"
                            class="w-10 h-10 rounded-full object-cover">
                        <div>
                            <p class="font-semibold text-slate-900">Ghea A.</p>
                        </div>
                        <span class="ml-auto text-xs bg-indigo-100 text-indigo-600 px-2.5 py-1 rounded-full">{{
                            __('beranda.testimoni_tag') }}</span>
                    </div>
